        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className=" text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer hover:scale-105 duration-500 scroll-smooth transition-colors "
            >
              Resume
              <span className="">
                {" "}
